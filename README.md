...
**Link**: [https://proceedings.mlr.press/v37/ganin15.pdf](https://proceedings.mlr.press/v37/ganin15.pdf)  
**Description**: Negates the gradient of the discriminator for the feature extractor to train both networks simultaneously.  
**Implementation**: [dann.py](./uda/dann.py)
...
**Implementation**: [adda.py](./uda/adda.py)
...
**Implementation**: [wdgrl.py](./uda/wdgrl.py)
...
```bash
python uda/dann.py trained_models/source.pth
python uda/adda.py trained_models/source.pth
python uda/wdgrl.py trained_models/source.pth
```

5. Test with `--source` optional:
```bash
python test_model.py trained_models/dann.pth
python test_model.py trained_models/adda.pth
python test_model.py trained_models/wdgrl.pth
```