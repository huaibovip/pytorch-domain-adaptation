...
from libs.models import Net
from libs.utils import GrayscaleToRgb
...
def main(args):
    ...
    lr_schedule = torch.optim.lr_scheduler.ReduceLROnPlateau(optim, patience=1)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), "trained_models/source.pth")
