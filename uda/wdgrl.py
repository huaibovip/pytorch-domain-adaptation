...
from libs.dataset import MNISTM
from libs.utils import loop_iterable, set_requires_grad, GrayscaleToRgb
...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        torch.save(clf_model.state_dict(), "trained_models/wdgrl.pth")
